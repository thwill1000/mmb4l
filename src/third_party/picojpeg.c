// https://github.com/richgel999/picojpeg/blob/master/picojpeg.c@8ab33a909b41
...
static int16 getExtendOffset(uint8 i)
{
   switch (i)
   {
      ...
      case 1: return (int16)((~0U << 1) + 1);
      case 2: return (int16)((~0U << 2) + 1);
      case 3: return (int16)((~0U << 3) + 1);
      case 4: return (int16)((~0U << 4) + 1);
      case 5: return (int16)((~0U << 5) + 1);
      case 6: return (int16)((~0U << 6) + 1);
      case 7: return (int16)((~0U << 7) + 1);
      case 8: return (int16)((~0U << 8) + 1);
      case 9: return (int16)((~0U << 9) + 1);
      case 10: return (int16)((~0U << 10) + 1);
      case 11: return (int16)((~0U << 11) + 1);
      case 12: return (int16)((~0U << 12) + 1);
      case 13: return (int16)((~0U << 13) + 1);
      case 14: return (int16)((~0U << 14) + 1);
      case 15: return (int16)((~0U << 15) + 1);
      default: return 0;
   }
};
//------------------------------------------------------------------------------
