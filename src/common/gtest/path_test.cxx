...
TEST_F(PathTest, Munge_Succeeds) {
    ...
    TEST_MUNGE("C:/foo/..",       "C:/");
#else
    TEST_MUNGE("a:",              "a:");  // Without a trailing '/' this should
    TEST_MUNGE("A:",              "A:");  // be treated as a drive path and not
    TEST_MUNGE("c:",              "c:");  // an absolute path, so we leave it
    TEST_MUNGE("C:",              "C:");  // unchanged.
    TEST_MUNGE("a:/",             "/");
    TEST_MUNGE("A:/",             "/");
    TEST_MUNGE("c:/",             "/");
    TEST_MUNGE("C:/",             "/");
